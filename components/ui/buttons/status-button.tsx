...
export default function StatusButton() {
  ...
  return (
    <button
      ...
      disabled={!isEnabled}
      type="submit"
      className="group relative h-10 min-w-40 overflow-hidden rounded-md bg-[#a7adb2] px-6 text-sm font-semibold text-white transition-colors duration-300 hover:bg-[#cbcfd2]"
    >
