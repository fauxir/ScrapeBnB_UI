...
export default function SwapTextCard({
  ...
  return (
    <div className="group flex min-h-48 w-full flex-col justify-between rounded-3xl p-6 md:w-full bg-white/10 dark:bg-black/10 backdrop-blur-md border border-white/20 dark:border-black/20 shadow-lg opacity-90">
      <h5 className="mb-2 text-sm font-medium uppercase tracking-wide text-gray-500">
        Powered by{" "}
        <Link
          href="https://www.npmjs.com/package/scrapebnb"
          target="_blank"
          rel="noopener noreferrer"
        >
          <span className="text-orange-500">ScrapeBnB</span>
        </Link>
      </h5>
